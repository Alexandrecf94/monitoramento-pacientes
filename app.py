...
def autenticar():
    ...
    if not st.session_state["autenticado"]:
        ...
        # Interromper o restante do aplicativo enquanto não autenticado
        if not st.session_state["autenticado"]:
            return False
    return True
...
if not autenticar():
    st.stop()  # Impedir execução do restante do código até autenticar

# Código principal do aplicativo (exemplo)
